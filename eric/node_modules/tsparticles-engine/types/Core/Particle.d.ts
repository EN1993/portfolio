import type { ICenterCoordinates, ICoordinates, ICoordinates3d } from "tsparticles-engine/types/Core/Interfaces/ICoordinates";
...
import type { IMovePathGenerator } from "tsparticles-engine/types/Core/Interfaces/IMovePathGenerator";
import type { IParticle } from "tsparticles-engine/types/Core/Interfaces/IParticle";
...
import type { ISlowParticleData } from "tsparticles-engine/types/Core/Interfaces/ISlowParticleData";
import { Interactivity } from "tsparticles-engine/types/Options/Classes/Interactivity/Interactivity";
import { ParticleOutType } from "tsparticles-engine/types/Enums/Types/ParticleOutType";
...
import { Vector } from "tsparticles-engine/types/Core/Utils/Vector";
import { Vector3d } from "tsparticles-engine/types/Core/Utils/Vector3d";
