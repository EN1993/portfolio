import type { EasingType, EasingTypeAlt } from "tsparticles-engine/types/Enums/Types/EasingType";
import type { IPositionFromSizeParams, IRangedPositionFromSizeParams } from "tsparticles-engine/types/Core/Interfaces/IPositionFromSizeParams";
import type { ICoordinates } from "tsparticles-engine/types/Core/Interfaces/ICoordinates";
import type { IValueWithRandom } from "tsparticles-engine/types/Options/Interfaces/IValueWithRandom";
import { MoveDirection } from "tsparticles-engine/types/Enums/Directions/MoveDirection";
import type { MoveDirectionAlt } from "tsparticles-engine/types/Enums/Directions/MoveDirection";
import type { RangeValue } from "tsparticles-engine/types/Types/RangeValue";
